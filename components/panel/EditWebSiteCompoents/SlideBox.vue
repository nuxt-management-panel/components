...
export default {
  ...
  data() {
    return {
      ...
      url: '/website/slide_box_component',
      modal: null,
      modalTitle: null,
      modalType: 'add',
      body: {
      ...
      types: null,
      tableConfig: {
        headers: ['ردیف', 'عنوان 1', 'عنوان 2', 'لینک', 'آیکون', 'عملیات'],
        cols: ['col-2 col-md-1', 'col-7 col-md-3', 'col-7 col-md-2', 'col-7 col-md-2', 'col-7 col-md-2', 'col-7 col-md-2', 'col-7 col-md-2', 'col-3 col-md-1'],
        body: {
          keys: ['counter', 'title', 'subtitle', 'link', 'icon', 'action'],
          actions: ['edit', 'delete']
        },
        data: null
      },
  ...
  methods: {
    ...
    async add() {
      ...
      if (this.body.subtitle)
        formData.append('subtitle', this.body.subtitle)
      if (this.body.link)
        formData.append('link', this.body.link)
